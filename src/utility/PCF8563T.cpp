/*****
 *  NAME
 *    PCF8563T Real Time Clock support routines
 *  AUTHOR
 *    Afantor
 *  NOTES
 *
...
byte PCF8563T::decToBcd(byte val)
{
    return ( (val/10*16) + (val%10) );
}

byte PCF8563T::bcdToDec(byte val)
{
    return ( (val/16*10) + (val%16) );
}

void PCF8563T::zeroClock()
{
...
* Read status byte
*/
byte PCF8563T::readStatus2()
{
    getDateTime();
    return getStatus2();
}

void PCF8563T::clearVoltLow(void)
{
    getDateTime();
...
*/
void PCF8563T::getDateTime(void)
{
...
void PCF8563T::setDateTime(byte day, byte weekday, byte month,
 ...
 * be sent out pin 3 of the Pcf8563 chip
 */
void PCF8563T::setAlarm(byte min, byte hour, byte day, byte weekday)
{
    getDateTime();  // operate on current values
    if (min <99) {
    ...
    PCF8563T::enableAlarm();
}

void PCF8563T::clearAlarm()
{
...
void PCF8563T::enableTimer(void)
{
    getDateTime();
    //set TE to 1
...
void PCF8563T::setTimer(byte value, byte frequency, bool is_pulsed)
{
    getDateTime();
    if (is_pulsed)
        status2 |= is_pulsed << 4;
...
*/
void PCF8563T::setSquareWave(byte frequency)
{
    Wire.beginTransmission(Rtcc_Addr);    // Issue I2C start signal
...
void PCF8563T::clearSquareWave()
{
    PCF8563T::setSquareWave(SQW_DISABLE);
}

const char *PCF8563T::formatTime(byte style)
{
    getTime();
    switch (style) {
        case RTCC_TIME_HM:
...
const char *PCF8563T::formatDate(byte style)
{
    getDate();
...
void PCF8563T::setTime(byte hour, byte minute, byte sec)
{
    getDateTime();
    setDateTime(getDay(), getWeekday(), getMonth(),
...
void PCF8563T::setDate(byte day, byte weekday, byte month, bool century, byte year)
{
    getDateTime();
...
void PCF8563T::getDate()
{
    getDateTime();
}

void PCF8563T::getTime()
{
    getDateTime();
}

bool PCF8563T::getVoltLow(void)
{
    return volt_low;
}

byte PCF8563T::getSecond() {
    return sec;
}

byte PCF8563T::getMinute() {
    return minute;
}

byte PCF8563T::getHour() {
    return hour;
}

byte PCF8563T::getAlarmMinute() {
    return alarm_minute;
}

byte PCF8563T::getAlarmHour() {
    return alarm_hour;
}

byte PCF8563T::getAlarmDay() {
    return alarm_day;
}

byte PCF8563T::getAlarmWeekday() {
    return alarm_weekday;
}

byte PCF8563T::getTimerControl() {
    return timer_control;
}

byte PCF8563T::getTimerValue() {
...
byte PCF8563T::getDay() {
    return day;
}

byte PCF8563T::getMonth() {
    return month;
}

byte PCF8563T::getYear() {
    return year;
}

bool PCF8563T::getCentury() {
    return century;
}

byte PCF8563T::getWeekday() {
    return weekday;
}

byte PCF8563T::getStatus1() {
    return status1;
}

byte PCF8563T::getStatus2() {
    return status2;
}
