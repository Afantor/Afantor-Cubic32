...
int TouchScreen::setCalibrationMatrix( POINT * displayPtr, POINT * screenPtr, MATRIX * matrixPtr)
{
    int  retValue = OK ;
...
int TouchScreen::getDisplayPoint( POINT * displayPtr, POINT * screenPtr, MATRIX * matrixPtr )
{
    int  retValue = OK ;
