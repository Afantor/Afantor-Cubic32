...
inline int PCF8563T::leapDaysBetween(byte century_start, byte year_start,
                                        byte century_end, byte year_end) const {
...
inline bool PCF8563T::isLeapYear(byte century, int year) const
{
...
inline byte PCF8563T::daysInMonth(byte century,
                                     byte year,
                                     byte month) const
{
...
inline byte PCF8563T::daysInYear(byte century,
                                    byte year,
                                    byte month,
                                    byte day) const
{
...
inline byte PCF8563T::whatWeekday(byte day, byte month,
