/*!
* @file LCD_ILI9341.cpp
*
* @mainpage LCD ILI9341 TFT Displays
*
* @section intro_sec Introduction
*
* This is the documentation for LCD ILI9341 driver for the
* Arduino platform. 
*
* This library works with the 2.4" TFT LCD with Touchscreen - ILI9341
*
...
*/
/**************************************************************************/
uint16_t LCD_ILI9341::color565(uint8_t red, uint8_t green, uint8_t blue) {
...
*/
/**************************************************************************/
LCD_ILI9341::LCD_ILI9341(int8_t cs, int8_t dc, int8_t mosi,
...
*/
/**************************************************************************/
LCD_ILI9341::LCD_ILI9341(int8_t cs, int8_t dc, int8_t rst) : Adafruit_GFX(ILI9341_TFTWIDTH, ILI9341_TFTHEIGHT) {
    _cs   = cs;
    _dc   = dc;
    _rst  = rst;
    _sclk  = -1;
...
void LCD_ILI9341::begin(uint32_t freq)
{
#ifdef ESP32
    _spi = HSPI;
#endif
...
*/
/**************************************************************************/
void LCD_ILI9341::invertDisplay(boolean invert) {
    startWrite();
...
*/
/**************************************************************************/
void LCD_ILI9341::scrollTo(uint16_t y) {
    startWrite();
...
*/
/**************************************************************************/
void LCD_ILI9341::setAddrWindow(uint16_t x, uint16_t y, uint16_t w, uint16_t h) {
...
*/
/**************************************************************************/
void LCD_ILI9341::writePixel(uint16_t color){
    SPI_WRITE16(color);
}
...
*/
/**************************************************************************/
void LCD_ILI9341::writePixels(uint16_t * colors, uint32_t len){
...
*/
/**************************************************************************/
void LCD_ILI9341::writeColor(uint16_t color, uint32_t len){
#ifdef SPI_HAS_WRITE_PIXELS
    if(_sclk >= 0){
...
*/
/**************************************************************************/
void LCD_ILI9341::writePixel(int16_t x, int16_t y, uint16_t color) {
...
*/
/**************************************************************************/
void LCD_ILI9341::writeFillRect(int16_t x, int16_t y, int16_t w, int16_t h, uint16_t color){
...
*/
/**************************************************************************/
void LCD_ILI9341::writeFastVLine(int16_t x, int16_t y, int16_t l, uint16_t color){
...
*/
/**************************************************************************/
void LCD_ILI9341::writeFastHLine(int16_t x, int16_t y, int16_t l, uint16_t color){
...
*/
/**************************************************************************/
void LCD_ILI9341::drawFastVLine(int16_t x, int16_t y,
...
*/
/**************************************************************************/
void LCD_ILI9341::drawFastHLine(int16_t x, int16_t y,
        int16_t l, uint16_t color) {
    startWrite();
...
*/
/**************************************************************************/
void LCD_ILI9341::fillRect(int16_t x, int16_t y, int16_t w, int16_t h,
        uint16_t color) {
    startWrite();
...
*/
/**************************************************************************/
void LCD_ILI9341::drawRGBBitmap(int16_t x, int16_t y,
...
*/
/**************************************************************************/
uint8_t LCD_ILI9341::readcommand8(uint8_t command, uint8_t index) {
    uint32_t freq = _freq;
    if(_freq > 24000000){
        _freq = 24000000;
    }
...
*/
/**************************************************************************/
void LCD_ILI9341::startWrite(void){
...
*/
/**************************************************************************/
void LCD_ILI9341::endWrite(void){
    SPI_CS_HIGH();
    SPI_END_TRANSACTION();
}
...
*/
/**************************************************************************/
void LCD_ILI9341::writeCommand(uint8_t cmd){
    SPI_DC_LOW();
    spiWrite(cmd);
    SPI_DC_HIGH();
}
...
*/
/**************************************************************************/
void LCD_ILI9341::spiWrite(uint8_t b) {
    if(_sclk < 0){
        HSPI_WRITE(b);
        return;
    }
